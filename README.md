...
- [Links](#links)
- Solution URL: [ https://github.com/ajormoses/express-chart-component.git ]
- Live Site URL: [ https://ajormoses.github.io/express-chart-component/ ]

- [Built with](#built-with)
  I use HTML, Sass CSS & JAVASCRIPT (Chart.js) to build this design
